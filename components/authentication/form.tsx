    ...
    <div className="text-white px-4 md:px-0">
      ...
      <div className="w-full mx-auto md:mx-0 md:w-3/4">
        <div className="w-full mt-8 flex flex-col gap-2">
          <button className="rounded-full w-full bg-gray-100 py-2 flex items-center justify-center gap-2 cursor-pointer">
            <FcGoogle size={24} />
          ...
          <button className="rounded-full w-full bg-gray-100 py-2 flex items-center justify-center gap-2 cursor-pointer">
            <FaApple size={24} className="text-gray-950" />
            <span className="text-black font-semibold">
              Sign up with Google
            </span>
          </button>
        ...
        <div className="mt-4">
          <button
            ...
            className="rounded-full font-semibold w-full bg-sky-500 py-2 cursor-pointer"
          >
            Create Account
          </button>
        </div>
